...
2. Получить токен пользователя ВК [здесь](https://vkhost.github.io/) и токен сообщества, внести их в соответствующие поля в config.py
3. Создать базу данных (скрипт находится в db.py, схема приложена)
